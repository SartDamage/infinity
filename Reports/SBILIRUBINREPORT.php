...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./S_BilirubinReport.aspx" id="aspnetForm" class="section-to-print">
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">S. BILIRUBIN</div>
        </div>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_S_BilirubinReport.php",
