        ...
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtESR" type="text" maxlength="100" id="ctl00_reportmaster_txtESR" class="txtbox-css width-90px margin-left-97" /></td>
...
//alert(str.replace(/[^\+a-zA-Z\d0-9\s]/g, ""));
