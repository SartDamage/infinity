...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./CBCReport.aspx?RegistrationID=oqe8RT1H7X6g5u0GL6oARw%3d%3d&amp;PatientId=v5bFEhGDs%2fGwy0JabwVc5A%3d%3d" id="aspnetForm" class="section-to-print">
     ...
     <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">CBC</div>
        </div>
