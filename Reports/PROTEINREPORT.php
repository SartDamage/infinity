...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">PROTEIN</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">C - Reactive Protein</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtCReactiveProtein" type="text" maxlength="100" id="ctl00_reportmaster_txtCReactiveProtein" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
                 <tr>
                    <td class="width-40">TITRE</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtTITRE" type="text" maxlength="100" id="ctl00_reportmaster_txtTITRE" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
        ...
        <div class="hmms-rptnote">
            <span>Method - Immuno Turbidometry<br /></span>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtCReactiveProtein"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtTITRE"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtCReactiveProtein").focus();
		$("#ctl00_reportmaster_txtCReactiveProtein").addClass('error').removeClass('noerror');
        return false;	
    }else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtTITRE").focus();
		$("#ctl00_reportmaster_txtTITRE").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtCReactiveProtein', jsonforindividual.C_reactive_protein);
setSelectValue('ctl00_reportmaster_txtTITRE', jsonforindividual.Titre);
}
	else{}
}  	
