...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">RETIC COUNT</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Reticulocyte Count</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtReticulocyte" type="text" maxlength="100" id="ctl00_reportmaster_txtReticulocyte" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">Adults-0.5 - 1.5%
                        <br/>
                        New Born - 2.5 - 6.0%
                    </td>
                </tr>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_ReticCountReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtReticulocyte"].value;
    if(a == "" || a == null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtReticulocyte").focus();
		$("#ctl00_reportmaster_txtReticulocyte").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtReticulocyte', jsonforindividual.Reticulocyte_count);
}
	else{}
}  	
