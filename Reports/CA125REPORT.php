...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">CA-125</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">CA-125</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtca" type="text" maxlength="100" id="ctl00_reportmaster_txtca" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">Upto 35 U/ml</td>
                </tr>
...
function validateForm() {
    var ca = document.forms["aspnetForm"]["ctl00_reportmaster_txtca"].value;
    if (ca == "" || ca == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtca").focus();
		$("#ctl00_reportmaster_txtca").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtca', jsonforindividual.CA_125);
}
	else{}
}  	
