...
<input type="hidden" name="ctl00_reportmaster_hfAdminID" id="ctl00_reportmaster_hfAdminID" />
    <input type="hidden" name="ctl00_reportmaster_hfSputumAfb3Samples" id="ctl00_reportmaster_hfSputumAfb3Samples" value="0" />
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">SPUTUM AFB 3 SAMPLES</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Sputum AFB FOR I DAY</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtSputumafbforIday" type="text" maxlength="100" id="ctl00_reportmaster_txtSputumafbforIday" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
				 <tr>
                    <td class="width-40">Sputum AFB FOR II DAY</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtSputumafbforIIday" type="text" maxlength="100" id="ctl00_reportmaster_txtSputumafbforIIday" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                </tr>
				 <tr>
                    <td class="width-40">Sputum AFB FOR III DAY</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtSputumafbforIIIday" type="text" maxlength="100" id="ctl00_reportmaster_txtSputumafbforIIIday" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
				 <tr>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_SputumAfb3SamplesReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtSputumafbforIday"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtSputumafbforIIday"].value;
    var c = document.forms["aspnetForm"]["ctl00_reportmaster_txtSputumafbforIIIday"].value;
    ...
    if(a == "" || a == null){
		...
		$("#ctl00_reportmaster_txtSputumafbforIday").focus();
		$("#ctl00_reportmaster_txtSputumafbforIday").addClass('error').removeClass('noerror');
	}else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtSputumafbforIIday").focus();
		$("#ctl00_reportmaster_txtSputumafbforIIday").addClass('error').removeClass('noerror');
	}else if(c=="" || c==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtSputumafbforIIIday").focus();
		$("#ctl00_reportmaster_txtSputumafbforIIIday").addClass('error').removeClass('noerror');
	}else if(d=="" || d==null){
		alert("Parameters must be filled must be filled out");
...
setSelectValue('ctl00_reportmaster_txtSputumafbforIday', jsonforindividual.Sputum_afb_for_1_day);

setSelectValue('ctl00_reportmaster_txtSputumafbforIIday', jsonforindividual.Sputum_afb_for_2_day);

setSelectValue('ctl00_reportmaster_txtSputumafbforIIIday', jsonforindividual.Sputum_afb_for_3_day);
