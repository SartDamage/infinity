...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">PROLACTINE</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Sr. Prolactin</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtSrProlactin" type="text" maxlength="100" id="ctl00_reportmaster_txtSrProlactin" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">Females :
                                         Normally Menstruating :2.8 - 29 ng / ml
				 ...
				 <tr>
                    ...
                    <td class="width-40">30 - 150 mg / dl
                    </td>
                </tr>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_ProlactineReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtSrProlactin"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtMethod"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtSrProlactin").focus();
		$("#ctl00_reportmaster_txtSrProlactin").addClass('error').removeClass('noerror');
        return false;	
    }else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtSrProlactin', jsonforindividual.Sr_prolactin);
