<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="" id="aspnetForm" class="section-to-print" class="section-to-print">
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">HBS AG</div>
        </div>
...
function validateForm() {
    var result = document.forms["aspnetForm"]["ctl00_reportmaster_txtResult"].value;
    var method = document.forms["aspnetForm"]["ctl00_reportmaster_txtMethod"].value;
