...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">HBA1C</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Result (HBA1C)</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtResultHBA1C" type="text" maxlength="100" id="ctl00_reportmaster_txtResultHBA1C" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
						Normal  <5.7%<br />
						Pre-diabetes : 5.7% - 6.4%<br />
						Diabetic : 6.5% or higher<br />
                    </td>
                </tr>
               </table>
        </div>
        <div class="hmms-rptnote">
            <span>Method : COLOUMN CHROMATOGRAPHY<br /><br />

<!--Normal Range : Normal 6.0 - 8.3 % GLY - HB<br />
 Good Diabetic Control 7.5 - 9.0 % GLY - HB<br />
 Fair Control 9.0 - 10 % GLY - HB<br />
 Poor Control > 10.0 % GLY - HB <br />--></span>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtResultHBA1C"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtResultHBA1C").focus();
		$("#ctl00_reportmaster_txtResultHBA1C").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtResultHBA1C', jsonforindividual.Result_HBA1C);
}
	else{}
}  	
