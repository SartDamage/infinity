...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">EXAMINATION OF BLOOD (HAEMOGLOBIN)</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-40">12 To 16 gm/dl</td>
                </tr>
...
function validateForm() {
    var hb = document.forms["aspnetForm"]["ctl00_reportmaster_txtHaemoglobin"].value;
    if (hb == "" || hb == null) {
