...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">STOOL C/S</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
				...
				<tr>
                    <td class="width-40">REPORT</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_TextBox1" type="text" maxlength="100" id="ctl00_reportmaster_TextBox1" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
				 <tr>
...
function validateForm() {
    ...
    var c = document.forms["aspnetForm"]["ctl00_reportmaster_TextBox1"].value;
    var d = document.forms["aspnetForm"]["ctl00_reportmaster_txtResult1"].value;
    var e = document.forms["aspnetForm"]["ctl00_reportmaster_txtWetmount"].value;
    var f = document.forms["aspnetForm"]["ctl00_reportmaster_txtResult"].value;
    var g = document.forms["aspnetForm"]["ctl00_reportmaster_txtNote"].value;
    if(a == "" || a == null){
		...
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_TextBox1").focus();
		$("#ctl00_reportmaster_TextBox1").addClass('error').removeClass('noerror');
	}else if(d=="" || d==null){
		alert("Parameters must be filled must be filled out");
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_TextBox1', jsonforindividual.Method);
		setSelectValue('ctl00_reportmaster_txtResult1', jsonforindividual.M_Rsult);
		setSelectValue('ctl00_reportmaster_txtWetmount', jsonforindividual.	Wet_mount);
		setSelectValue('ctl00_reportmaster_txtResult', jsonforindividual.O_Result);
