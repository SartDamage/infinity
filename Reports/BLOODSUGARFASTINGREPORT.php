...
<div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">BLOOD SUGAR FASTING</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Blood Sugar</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtBloodSugar" type="text" maxlength="100" id="ctl00_reportmaster_txtBloodSugar" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">60 - 110 mg/dl
                    </td>
                </tr>
                 <tr>
                    <td class="width-40">Urine Sugar</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtUrineSugar" type="text" maxlength="100" id="ctl00_reportmaster_txtUrineSugar" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
                 <tr>
                    <td class="width-40">Urine Acetone</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtUrineAcetone" type="text" maxlength="100" id="ctl00_reportmaster_txtUrineAcetone" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">
                    </td>
                </tr>
			...
			<td>
				...
				<table class="ref_range_tab">
					...
					<tbody>
						...
						<tr><td>Impaired fasting Glucose</td><td>101 - 125</td></tr>
						<tr><td>Impaired Glucose Tolerance</td><td>70 - 100</td></tr>
						<tr><td>Pre diabetes</td><td>101 - 125</td></tr>
						<tr><td>Diabetes mellitus</td><td>>126</td></tr>
					</tbody>
				</table>
				</center>
			</td>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_BloodSugarFastingReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtBloodSugar"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtUrineSugar"].value;
    ...
    if (a == "" || a == null) {
		...
		$("#ctl00_reportmaster_txtBloodSugar").focus();
		$("#ctl00_reportmaster_txtBloodSugar").addClass('error').removeClass('noerror');
        return false;	
    }else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtUrineSugar").focus();
		$("#ctl00_reportmaster_txtUrineSugar").addClass('error').removeClass('noerror');
	}else if(c=="" || c==null){
		alert("Parameters must be filled must be filled out");
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtBloodSugar', jsonforindividual.Blood_sugar);
	setSelectValue('ctl00_reportmaster_txtUrineSugar', jsonforindividual.Urine_sugar);
	setSelectValue('ctl00_reportmaster_txtUrineAcetone', jsonforindividual.Urine_acetone);
	}
	else{}
}  	
	</script>
