...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">CPK/CPK-MB</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">CPK</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtCpk" type="text" maxlength="100" id="ctl00_reportmaster_txtCpk" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">Male : <171 U/L.
Female : <145 U/L.
                    </td>
                </tr>
				<tr>
                    <td class="width-40">CPK - MB</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtCpkmb" type="text" maxlength="100" id="ctl00_reportmaster_txtCpkmb" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">Up to 25 U/L.
                    </td>
                </tr>
				<tr>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtCpk"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtCpkmb"].value;
    var c = document.forms["aspnetForm"]["ctl00_reportmaster_txtSugar"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtCpk").focus();
		$("#ctl00_reportmaster_txtCpk").addClass('error').removeClass('noerror');
        return false;	
    }else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtCpkmb").focus();
		$("#ctl00_reportmaster_txtCpkmb").addClass('error').removeClass('noerror');
	}else if(c=="" || c==null){
		alert("Parameters must be filled must be filled out");
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtCpk', jsonforindividual.Cpk);
setSelectValue('ctl00_reportmaster_txtCpkmb', jsonforindividual.Cpk_mb);
