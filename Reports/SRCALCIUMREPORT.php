...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">SR. CALCIUM</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Calcium</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtCalcium" type="text" maxlength="100" id="ctl00_reportmaster_txtCalcium" class="txtbox-css width-90px margin-left-97" />
					</td>
                    <td class="width-40">8 - 10 mg / dl
                    </td>
                </tr>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtCalcium"].value;
    if(a == "" || a == null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtCalcium").focus();
		$("#ctl00_reportmaster_txtCalcium").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
setSelectValue('ctl00_reportmaster_txtCalcium', jsonforindividual.Calcium);
}
	else{}
}
