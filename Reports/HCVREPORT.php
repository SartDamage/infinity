...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">HCV</div>
        </div>
            ...
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
                        <!--<input name="ctl00_reportmaster_txtHCVAntibody" type="text" maxlength="100" id="ctl00_reportmaster_txtHCVAntibody" class="txtbox-css width-90px margin-left-97" />-->
							<select name="ctl00_reportmaster_txtHCVAntibody" id="ctl00_reportmaster_txtHCVAntibody"  class="txtbox-css width-90px margin-left-97">
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
						...
						<select name="ctl00_reportmaster_txtResult" id="ctl00_reportmaster_txtResult"  class="txtbox-css width-90px margin-left-97">
						  <option value="">Select Value</option>
...
function validateForm() {
    ...
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtHCVAntibody"].value;
    if (a == "" || a == null) {
		...
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtHCVAntibody").focus();
		$("#ctl00_reportmaster_txtHCVAntibody").addClass('error').removeClass('noerror');
	}else{ return true;}
}
