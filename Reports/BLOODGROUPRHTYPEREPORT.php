...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">BLOOD GROUP & RH FACTOR</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Blood Group</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtBloodGroup" type="text" maxlength="100" id="ctl00_reportmaster_txtBloodGroup" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40"></td>
                </tr>
                <tr>
                    <td class="width-40">Rh Factor</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtRhFactor" type="text" maxlength="100" id="ctl00_reportmaster_txtRhFactor" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40"></td>
                </tr>
        ...
        <div class="hmms-rptnote">
            <span>METHOD : SLIDE AGGUTINATION</span>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_BloodGroupRhTypeReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtRhFactor"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtBloodGroup"].value;
    ...
    if (a == "" || a == null) {
		...
		$("#ctl00_reportmaster_txtRhFactor").focus();
		$("#ctl00_reportmaster_txtRhFactor").addClass('error').removeClass('noerror');
        return false;	
    }else if(b=="" || b==null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtBloodGroup").focus();
		$("#ctl00_reportmaster_txtBloodGroup").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtBloodGroup', jsonforindividual.Blood_group);
		setSelectValue('ctl00_reportmaster_txtRhFactor', jsonforindividual.Rh_factor);
	}
	else{}
}  	
