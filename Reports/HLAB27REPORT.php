...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">HLA-B27</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">HLA-B27 Result</td>
                    <td class="width-20 text-center">
                        <!--<input name="ctl00_reportmaster_txtHLAB27" type="text" maxlength="100" id="ctl00_reportmaster_txtHLAB27" class="txtbox-css width-90px margin-left-97" />-->
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
                        <textarea name="ctl00_reportmaster_txtMethod" type="text" maxlength="100" id="ctl00_reportmaster_txtMethod" class="txtbox-css  margin-left-97" >
						</textarea>
					</td>
                    <td class="width-40"></td>
                </tr>
...
function validateForm() {
    var intr = document.forms["aspnetForm"]["ctl00_reportmaster_txtMethod"].value;
    var dng = document.forms["aspnetForm"]["ctl00_reportmaster_txtResult"].value;
    if (dng == "" || dng == null) {
