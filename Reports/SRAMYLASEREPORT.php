...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">SR. AMYLASE</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-20">Amylase</td>
                    <td class="width-20 text-center">
						<input name="ctl00_reportmaster_txtcholtrol" type="text" maxlength="100" id="ctl00_reportmaster_txtcholtrol" class="txtbox-css width-90px margin-left-97" />
					</td>
                    <td class="width-40">0 – 140 U/L</td>
                </tr>
...
setSelectValue('ctl00_reportmaster_txtcholtrol', jsonforindividual.Amalyase);
}
	else{}
}
