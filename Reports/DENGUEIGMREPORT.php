...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./DengueIgmReport.aspx" id="aspnetForm" class="section-to-print">
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">DENGUE IGM</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Dengue - IgM</td>
                    <td class="width-20 text-center">
                        <!--<input name="ctl00_reportmaster_txtDengueIgM" type="text" maxlength="100" id="ctl00_reportmaster_txtDengueIgM" class="txtbox-css width-90px margin-left-97" />-->
						<select name="ctl00_reportmaster_txtDengueIgM" id="ctl00_reportmaster_txtDengueIgM"  class="txtbox-css width-90px margin-left-97">
        ...
        <div class="hmms-rptnote">
            <span>METHOD :- ONE STEP DENGUE IgM<br /></span>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtDengueIgM"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtDengueIgM").focus();
		$("#ctl00_reportmaster_txtDengueIgM").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtDengueIgM', jsonforindividual.Dengue_IgM);
}
	else{}
}  	
