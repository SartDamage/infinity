...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">EXAMINATION OF BLOOD (PLATELET)</div>
        </div>
            ...
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtHaemoglobin" type="text" maxlength="100" id="ctl00_reportmaster_txtHaemoglobin" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">150000 To 450000 Lack/cumm</td>
                </tr>
                
            </table>
        </div>
        <div class="hmms-rptnote">
            <span>CBC Done Only On Fully Automated (SYSMEX XP 100) Cell Counter.<br />
               </span>
...
function validateForm() {
    var platelet = document.forms["aspnetForm"]["ctl00_reportmaster_txtHaemoglobin"].value;
    if (platelet == "" || platelet == null) {
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtHaemoglobin', jsonforindividual.Platelet_Count);
}
	else{}
}  	
