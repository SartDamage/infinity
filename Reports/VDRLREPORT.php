...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./VDRLReport.aspx" id="aspnetForm" class="section-to-print">
</div>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">VDRL</div>
        </div>
        ...
        <div class="hmms-rptnote">
            <span>The test was run alongwith positive & negative controls.</span>
