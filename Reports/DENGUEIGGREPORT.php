...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./DengueIggReport.aspx" id="aspnetForm" class="section-to-print">
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">DENGUE IGG</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Dengue - IgG</td>
                    <td class="width-20 text-center">
                        <!--<input name="ctl00_reportmaster_txtDengueIgG" type="text" maxlength="100" id="ctl00_reportmaster_txtDengueIgG" class="txtbox-css width-90px margin-left-97" />-->
						<select name="ctl00_reportmaster_txtDengueIgG" id="ctl00_reportmaster_txtDengueIgG"  class="txtbox-css width-90px margin-left-97">
        ...
        <div class="hmms-rptnote">
            <span>METHOD :- ONE STEP DENGUE IgG<br /></span>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtDengueIgG"].value;
    if (a == "" || a == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtDengueIgG").focus();
		$("#ctl00_reportmaster_txtDengueIgG").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtDengueIgG', jsonforindividual.Dengue_IgG);
}
	else{}
}  	
