...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">SR. TRIGLYCERIDES</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Triglycerides</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtTriglycerides" type="text" maxlength="100" id="ctl00_reportmaster_txtTriglycerides" class="txtbox-css width-90px margin-left-97" /></td>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_SrTriglyceridesReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtTriglycerides"].value;
     if(a == "" || a == null){
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtTriglycerides").focus();
		$("#ctl00_reportmaster_txtTriglycerides").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
setSelectValue('ctl00_reportmaster_txtTriglycerides', jsonforindividual.Triglycerides);
}
	else{}
}
