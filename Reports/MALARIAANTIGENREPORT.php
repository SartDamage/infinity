...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">MALARIA ANTIGEN</div>
        </div>
                ...
                <tr>
                    ...
                    <td class="width-20 text-center">
						...
						<select name="ctl00_reportmaster_txtResult" id="ctl00_reportmaster_txtResult"  class="txtbox-css width-90px margin-left-97">
						  ...
						  <option value="positive">Present</option>
						  <option value="negative">Absent</option>
						</select>
						</td>
                    <td class="width-40">
                    </td>
        ...
        <div class="hmms-rptnote">
            <span>METHOD : RAPID ONE STEP MALARIA ANTIGEN RAPID TEST</span>
...
$.ajax({
	...
	$.ajax({
	   type: "GET",
	   url: "/set_p_MalariaAntigenReport.php",
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtResult"].value;
    if (a == "" || a == null) {
