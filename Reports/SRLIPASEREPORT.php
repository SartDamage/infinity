...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">BIOCHEMESTRY REPORT (SR. LIPASE)</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Amylase. Serum</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtAmylase" type="text" maxlength="100" id="ctl00_reportmaster_txtAmylase" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">0.0 - 90.0 U/L</td>
                </tr>
				<tr>
                    <td class="width-40">Lipase. Serum</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtLipase" type="text" maxlength="100" id="ctl00_reportmaster_txtLipase" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">0.0 - 160.0 U/L</td>
                </tr>
...
function validateForm() {
    var Amylase = document.forms["aspnetForm"]["ctl00_reportmaster_txtAmylase"].value;
   var Lipase = document.forms["aspnetForm"]["ctl00_reportmaster_txtLipase"].value;
    if (Amylase == "" || Amylase == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtAmylase").focus();
		$("#ctl00_reportmaster_txtAmylase").addClass('error').removeClass('noerror');
        return false;	
    }else  if (Lipase == "" || Lipase == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtLipase").focus();
		$("#ctl00_reportmaster_txtLipase").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtAmylase', jsonforindividual.Amylase_Serum);
setSelectValue('ctl00_reportmaster_txtLipase', jsonforindividual.Lipase_Serum);
}
	else{}
}  	
