...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">PERIFERAL SMEAR FOR MALARIAL PARASITE</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Malarial Parasite</td>
                    <td class="width-20 text-center">
                        <!--<input name="ctl00_reportmaster_txtMalarialParasite" type="text" maxlength="100" id="ctl00_reportmaster_txtMalarialParasite" class="txtbox-css width-90px margin-left-97" />-->
						<select name="ctl00_reportmaster_txtMalarialParasite" id="ctl00_reportmaster_txtMalarialParasite"  class="txtbox-css width-90px margin-left-97">
        ...
        <div class="hmms-rptnote">
            <span>Microscopic examination of thik and thin smears <br><br><br>
			CBC Done Only On Fully Automated (SYSMEX XP 100) Cell Counter.<br />
               </span>
...
function validateForm() {
    var ca = document.forms["aspnetForm"]["ctl00_reportmaster_txtMalarialParasite"].value;
    if (ca == "" || ca == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtMalarialParasite").focus();
		$("#ctl00_reportmaster_txtMalarialParasite").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtMalarialParasite', jsonforindividual.Malarial_parasite);
}
	else{}
}  	
