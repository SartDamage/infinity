...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">ERYTHROCYTE SEDIMENTATION RATE (ESR)</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-40">0 - 22 mm / hour for Male<br>0 - 29 mm / hour for Female.</td>
                </tr>
                
            </table>
        </div>
        <div class="hmms-rptnote">
            <span>Method - Westergrens</span>
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtcholtrol', jsonforindividual.Esrendof1hour);
