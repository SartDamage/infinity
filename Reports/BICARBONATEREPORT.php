...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">BICARBONATE</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Bicarbonate, serum</td>
                    ...
                    <td class="width-40">22 - 29 Meq/lt</td>
                </tr>
...
function validateForm() {
    var patTime = document.forms["aspnetForm"]["ctl00_reportmaster_txtBicarbonate"].value;
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtBicarbonate', jsonforindividual.Bicarbonate_serum);
	}
	else{}
}  	
