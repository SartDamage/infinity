<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="" id="aspnetForm" class="section-to-print">
        <div class="hmms_report section-to-print">
            <div class="hmms_hdr section-to-print">
    ...
    <div class="hmms_hdr section-to-print">
        <div class="">
		<div class="nodisplay"><br><br><br><br><br></div>
            <div class="hmms-reprtname">APTT</div>
        </div>
        ...
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    <td class="width-40">Patient Time</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtPatientTime" type="text" maxlength="100" id="ctl00_reportmaster_txtPatientTime" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">30 - 45 Sec.
                    </td>
                </tr>
...
$.ajax({
	   type: "GET",
	   url: "/get_p_APTTReport.php?ID="+ID+"&test="+str+"",
...
function validateForm() {
    var patTime = document.forms["aspnetForm"]["ctl00_reportmaster_txtPatientTime"].value;
    if (patTime == "" || patTime == null) {
        alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtPatientTime").focus();
		$("#ctl00_reportmaster_txtPatientTime").addClass('error').removeClass('noerror');
        return false;	
    }else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtPatientTime', jsonforindividual.Patient_time);
	}
	else{}
}  	
</script>
