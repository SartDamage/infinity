...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">TSH</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-40">0.2 - 6.0 uIU / ml
                    </td>
                </tr>
            </table>
        </div>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtTSH"].value;
    if(a == "" || a == null){
