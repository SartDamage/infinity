...
<?php include $_SERVER['DOCUMENT_ROOT']."/include/include_in_patho_report.php"; ?><body>
    <form method="post" action="./HdlCholReport.aspx" id="aspnetForm" class="section-to-print">
    ...
    <div class="hmms_hdr">
        <div class="">
            <div class="hmms-reprtname">HDL CHOL</div>
        </div>
        <div class="profile_tbl">
            <table class="width-100">
                ...
                <tr>
                    ...
                    <td class="width-40">30 - 70 mg / dl
                    </td>
                </tr>
				 <tr>
                    <td class="width-40">Cholesterol</td>
                    <td class="width-20 text-center">
                        <input name="ctl00_reportmaster_txtCholesterol" type="text" maxlength="100" id="ctl00_reportmaster_txtCholesterol" class="txtbox-css width-90px margin-left-97" /></td>
                    <td class="width-40">120 -220 mg / dl
                    </td>
                </tr>
...
function validateForm() {
    var a = document.forms["aspnetForm"]["ctl00_reportmaster_txtHDL"].value;
    var b = document.forms["aspnetForm"]["ctl00_reportmaster_txtCholesterol"].value;
    if (a == "" || a == null) {
		...
		alert("Parameters must be filled must be filled out");
		$("#ctl00_reportmaster_txtCholesterol").focus();
		$("#ctl00_reportmaster_txtCholesterol").addClass('error').removeClass('noerror');
	}else{ return true;}
}
...
function parseJsonToFormIndividual(jsonforindividual){
	...
	if (jsonforindividual){
		...
		setSelectValue('ctl00_reportmaster_txtHDL', jsonforindividual.HDL);
setSelectValue('ctl00_reportmaster_txtCholesterol', jsonforindividual.Cholesterol);
}
	else{}
}  	
