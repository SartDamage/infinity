...
<div id="main">
  ...
  <div class="container" id="reg-form-container" style="padding-left:50px;margin-top:15px;">
    ...
    <form id="cashless_form">
     ...
     <!--insert here-->
     <div class="card card-outline-info mb-3 section-notto-print non-printable" style="margin-bottom: 3rem;margin-top: 1rem" id="hide_bar">
          ...
          <div class="card-block" >
            <div class="container">
              <div class="row justify-content-center">
                ...
                <div class="col-md-2">
                  <button class="btn btn-outline-danger" id="button_print" onclick="window.print();"> <i class="fa fa-print fa-2x add_row" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; Print </button>
                </div>
              </div>
            </div>
          </div>
