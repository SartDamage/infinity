      ...
      <form class="form " name="tl_submit_form"  id="tl_submit_form" >
        ...
        <div class="form-group row justify-content-center"><!--Marital Status--><!--Contact no-->
         ...
         <label for="tl_age_wife" class="col-2 col-form-label required">Age of Wife</label>
          <div class="col-3">
            <input type="number" value="" class="form-control" id="tl_age_wife" tabindex="-1" placeholder="Enter the age of wife" name="tl_age_wife" style="width: 100%; resize: none;" readonly/>
          </div>
        </div>
        <!-------------------->
         <div class="form-group row justify-content-center">
        ...
        <div class="form-group row justify-content-center">
         <label for="tl_date" class="col-2 col-form-label required">Date of VT</label>
          ...
          <div class="col-3">
            <input type="number" class="form-control" id="tl_monthly_income"  placeholder="Enter the Monthly Income" name="tl_monthly_income" style="width: 100%; resize: none;" autocomplete="off"/>
      ...
      $.ajax({
           ...
           success: function(data)
           {
            ...
            if(data!="unsuccesful" && data !="" ){
              ...
              swalSuccess("VT record Successfully added");//alert
