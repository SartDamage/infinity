...
<?php 
							$db = getDB();
							$statement=$db->prepare("SELECT MAX(`PathoRegID`) FROM pathopatientregistrationparent");
							$statement->execute();
							...
							$patient_id= "PPR".str_pad($matches, 5, "0", STR_PAD_LEFT);
			...
			<form method="post" action="" class="form " name="pat_update_form"  id="pat_update_form" enctype="multipart/form-data" style="">
				<div class="form-group row justify-content-center"><!--ID-->
				  ...
				  <div class="col-3" style="/* display:none; */">
					<input class="form-control noerror" type="text" tabindex="-1" placeholder="patID" name="patID" value="<?php 
					if (isset($_GET['pat_id'])){echo $_GET['pat_id'];}
					else {echo $patient_id;}?>" id="patID"  readonly>
				...
				<div class="form-group row justify-content-center">
					...
					<div class="col-3">
					<select name="main_test-0" class="form-control" id="main-test-input-select-0" style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-0")'>
				...
				$db=null;
					...
					<label class="col-2 col-form-label required" for="sub_test-0" >Test name :</label>
					<div class="col-3">
					<select name="sub_test-0" class="form-control" onchange="dropdown_sub_test(this.id,'sub_test_amount-0')" id="sub_test-0" style="height: 44px;" data-amount="500">
								<option value="" disabled selected> Select main test first</option>
					</select>
					<input id="sub_test_amount-0" name="sub_test_amount-0" value="" type="text" hidden>
					</div>
				</div>
				<div class="form-group row justify-content-center"><!--Date of birth--><!--Contact no-->
					<label class="col-2 col-form-label " for="dr_assigned-0" >Signing Dr. :</label>
					<div class="col-3">
						<input type="text" list="Dr.Name" name="dr_assigned-0" class="form-control" id="dr_assigned-0" style="height: 44px;">
							<datalist id="Dr.Name">
                                                            <option value="">Select option</option>
								<?php 
								$db = getDB();
							$statement=$db->prepare("SELECT pdr.`pathologist_name`,pdr.`pathodrID` FROM `pathology_dr_assigned` AS pdr WHERE `IsActive`=1;");
							$statement->execute();
							$results=$statement->fetchAll();
							//$json=json_encode($results);
							//return $json;
					...
					<div class="col-3">
						<select name="sample_status-0"  class="form-control" id="sample_status-0" style="height: 44px;">
				...
				<div id="hiderow">
					<td colspan="5"><a id="addrow" class="addrow pull-right" href="javascript:;" title="Add a row" tabindex="-1"><i class="fal fa-plus-square fa-2x add_row pull-left" aria-hidden="true"></i></a></td>
				</div><!--fa fa-plus-square-o-->
				</div>
				<!------------------->
				<div class="item-row justify-content-center">
				<hr class="hr_seperator">
				<div class="form-group row last_row justify-content-center">
					<label class="col-2 col-form-label required" for="main-test-input-select-1" >Test category :</label>
					<div class="col-3">
					<select name="main_test-1" class="form-control" id="main-test-input-select-1" style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-1")'>
								<option value="" disabled selected> Select main test</option>
				<?php 
				$db = getDB();
				$statement=$db->prepare("SELECT * FROM pathologycategorymaster;");
				...
				$db=null;
					...
					<label class="col-2 col-form-label required" for="doctor_assigned" >Test name :</label>
					<div class="col-3">
					<select name="sub_test-1" class="form-control"  id="sub_test-1" onchange="dropdown_sub_test(this.id,'sub_test_amount-1')" style="height: 44px;">
								<option value="" disabled selected> Select main test first</option>
					</select>
					<input id="sub_test_amount-1" name="sub_test_amount-1" type="text" hidden>
					</div>
				</div>
				<div class="form-group row justify-content-center"><!--Date of birth--><!--Contact no-->
					<label class="col-2 col-form-label" for="dr_assigned" ></label>
					<div class="col-3">
						
					</div>
					<label class="col-2 col-form-label required" for="sample_status" >Sample collected :</label>
					<div class="col-3">
						<select name="sample_status-1" class="form-control" id="sample_status-1" style="height: 44px;">
								<option value="" disabled selected> Select option</option>
								<option value="1" > In lab</option>
								<option value="0" > Out of lab</option>
						</select>
				...
				<a class="delete" href="javascript:;" title="Remove row" tabindex="-1">X</a>
				<div id="hiderow">
					<td colspan="5">
                                            <a id="addrow" class="addrow pull-right" href="javascript:;" title="Add a row" tabindex="-1">
                                                <i class="fal fa-plus-square fa-2x add_row " aria-hidden="true"></i>
                                            </a>
                                        </td>
				</div>
				</div>
				...
				<hr class="hr_seperator">
				<div class="form-group row last_row justify-content-center">
					<label class="col-2 col-form-label required" for="main-test-input-select-2" >Test category :</label>
					<div class="col-3">
					<select name="main_test-2" class="form-control" id="main-test-input-select-2" style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-2")'>
								<option value="" disabled selected> Select main test</option>
				<?php 
				$db = getDB();
				$statement=$db->prepare("SELECT * FROM pathologycategorymaster;");
				...
				$db=null;
					...
					<label class="col-2 col-form-label required" for="sub_test-2" >Test name :</label>
					<div class="col-3">
					<select name="sub_test-2" class="form-control"  id="sub_test-2" onchange="dropdown_sub_test(this.id,'sub_test_amount-2')" style="height: 44px;">
								<option value="" disabled selected> Select main test first</option>
					</select>
					<input id="sub_test_amount-2" name="sub_test_amount-2" value="" type="text" hidden>
					</div>
				</div>
				<div class="form-group row justify-content-center"><!--Date of birth--><!--Contact no-->
					<label class="col-2 col-form-label " for="dr_assigned" ></label>
					...
					<label class="col-2 col-form-label required" for="sample_status" >Sample collected :</label>
					<div class="col-3">
						<select name="sample_status-2" class="form-control" id="sample_status-2" style="height: 44px;">
								<option value="" disabled selected> Select option</option>
								<option value="1" > In lab</option>
								<option value="0" > Out of lab</option>
						</select>
				...
				<a class="delete" href="javascript:;" title="Remove row" tabindex="-1">X</a>
				<div id="hiderow">
					<td colspan="5"><a id="addrow" class="addrow pull-right" href="javascript:;" title="Add a row" tabindex="-1"><i class="fal fa-plus-square fa-2x add_row" aria-hidden="true"></i></a></td>
				</div>
				</div>
				<!------------------->
				<div class="item-row justify-content-center">
				<hr class="hr_seperator">
				<div class="form-group row last_row justify-content-center">
					<label class="col-2 col-form-label required" for="main-test-input-select-3" >Test category :</label>
					<div class="col-3">
					<select name="main_test-3" class="form-control" id="main-test-input-select-3" style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-3")'>
								<option value="" disabled selected> Select main test</option>
				<?php 
				$db = getDB();
				$statement=$db->prepare("SELECT * FROM pathologycategorymaster;");
				...
				$db=null;
					...
					<label class="col-2 col-form-label required" for="sub_test-3" >Test name :</label>
					<div class="col-3">
					<select name="sub_test-3" class="form-control" id="sub_test-3" onchange="dropdown_sub_test(this.id,'sub_test_amount-3')" style="height: 44px;">
								<option value="" disabled selected> Select main test first</option>
					</select>
					<input id="sub_test_amount-3" name="sub_test_amount-3" value=""  type="text" hidden>
					</div>
				</div>
				<div class="form-group row justify-content-center"><!--Date of birth--><!--Contact no-->
					<label class="col-2 col-form-label " for="dr_assigned" ></label>
					...
					<label class="col-2 col-form-label required" for="sample_status" >Sample collected :</label>
					<div class="col-3">
						<select name="sample_status-3" class="form-control" id="sample_status-3" style="height: 44px;">
								<option value="" disabled selected> Select option</option>
								<option value="1" > In lab</option>
								<option value="0" > Out of lab</option>
						</select>
				...
				<hr class="hr_seperator">
				<div class="form-group row last_row justify-content-center">
					<label class="col-2 col-form-label required" for="main-test-input-select-4" >Test category :</label>
					<div class="col-3">
					<select name="main_test-4" class="form-control" id="main-test-input-select-4"  style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-4")'>
								<option value="" disabled selected> Select main test</option>
				<?php 
				$db = getDB();
				$statement=$db->prepare("SELECT * FROM pathologycategorymaster;");
				...
				$db=null;
					...
					<label class="col-2 col-form-label required" for="sub_test-4" >Test name :</label>
					<div class="col-3">
					<select name="sub_test-4" class="form-control"   id="sub_test-4" onchange="dropdown_sub_test(this.id,'sub_test_amount-4')" style="height: 44px;">
								<option value="" disabled selected> Select main test first</option>
					</select>
					<input id="sub_test_amount-4" name="sub_test_amount-4" value="" type="text" hidden>
					</div>
				...
				<div class="form-group row justify-content-center"><!--Date of birth--><!--Contact no-->
					...
					<label class="col-2 col-form-label required" for="sample_status" >Sample collected :</label>
					<div class="col-3">
						<select name="sample_status-4" class="form-control" id="sample_status-4" style="height: 44px;">
								<option value="" disabled selected> Select option</option>
								<option value="1" > In lab</option>
								<option value="0" > Out of lab</option>
						</select>
			...
			$.ajax({
				   ...
				   {	
						...
						if(data!="unsuccesful" && data !="" ){
							...
							var test1 = $('#sub_test-0 option:selected').data('subtestname');
							var test2 = $('#sub_test-1 option:selected').data('subtestname');
							var test3 = $('#sub_test-2 option:selected').data('subtestname');
							var test4 = $('#sub_test-3 option:selected').data('subtestname');
							var test5 = $('#sub_test-4 option:selected').data('subtestname');
							var today = new Date();
...
function validateForm() {
    var patID = document.forms["pat_update_form"]["patID"].value;
     var main_test_0 = document.forms["pat_update_form"]["main_test-0"].value;
    var main_test_1 = document.forms["pat_update_form"]["main_test-1"].value;
    var main_test_2 = document.forms["pat_update_form"]["main_test-2"].value;
    var main_test_3 = document.forms["pat_update_form"]["main_test-3"].value;
    var main_test_4 = document.forms["pat_update_form"]["main_test-4"].value;
    var sub_test_0 = document.forms["pat_update_form"]["sub_test-0"].value;
    var sub_test_1 = document.forms["pat_update_form"]["sub_test-1"].value;
    var sub_test_2 = document.forms["pat_update_form"]["sub_test-2"].value;
    var sub_test_3 = document.forms["pat_update_form"]["sub_test-3"].value;
    var sub_test_4 = document.forms["pat_update_form"]["sub_test-4"].value;
    var dr_assigned = document.forms["pat_update_form"]["dr_assigned-0"].value;
    var sample_status_0 = document.forms["pat_update_form"]["sample_status-0"].value;
    var sample_status_1 = document.forms["pat_update_form"]["sample_status-1"].value;
    var sample_status_2 = document.forms["pat_update_form"]["sample_status-2"].value;
    var sample_status_3 = document.forms["pat_update_form"]["sample_status-3"].value;
    var sample_status_4 = document.forms["pat_update_form"]["sample_status-4"].value;
    var advance = document.forms["pat_update_form"]["advance"].value;
    if (patID == "" ) {
        ...
        swalError("main test must be selected");//alert
		$("#main-test-input-select").focus();
		$("#main-test-input-select").addClass('error').removeClass('noerror');
        return false;
    }else if (sub_test_0 == "") {
        swalError("sub test must be selected");//alert
		$("#sub_test").focus();
		$("#sub_test").addClass('error').removeClass('noerror');
        return false;
    }else if (sample_status_0 == "" ) {
       swalError("sample status must be selected");//alert
		$("#sample_status").focus();
