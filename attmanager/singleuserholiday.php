			...
			<form method="post" action="" class="form " name="add_stock_form"  id="add_stock_form" enctype="multipart/form-data" style="">
				...
				<div class="form-group row justify-content-center"><!--Brand-->
				  ...
				  <?php
					  	$db = getDB();
											...
											$userbioid=$resultu['user_id'];
												}
											
					  ?>
					<input class="form-control noerror" type="text"  placeholder="Holiday Name" name="holidayname" value="<?php echo $usernameleave." ".$userlstleave; ?>" id="holidayname"  >
				...
				<div class="form-group row justify-content-center"><!--Brand-->
				  ...
				  <div class="col-lg-5">
					...
					<input class="form-control noerror" type="text"  placeholder="Holiday Name" name="idforprimary" value="<?php echo $userbioid; ?>" id="leavereason" hidden >
...
$( "form#add_stock_form" ).on( "submit", function( event ) {
	...
	//alert("hello world");
    var url = "/attmanager/add_leave_per_user.php"; // the script where you handle the form input.
	//validateForm(event)
