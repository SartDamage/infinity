...
/*****/
	...
	if($gender==null || $gender == "" || $fname==null || $fname == "" || $contact==null||$contact=="" || $address==null||$address=="" || $username==null||$username==""){
			...
			$reg_patient=$userClass->addstaff($fname,$lname,$username,$password,$email,$contact,$gender,$martial_status,$dob,$designation,$address,$bloodgroup,$avatar,$ice_name,$ice_contact,$ice_address,$roleid,$bio_id,$uid);//,$history);
			if($reg_patient){
