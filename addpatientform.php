...
<style>.form_header{border-bottom: dashed 1px #d1d0d0;padding-bottom: 10px;}
...
.form .seperator, .seperator{border: 0px;border-bottom: 1px dashed #b5babd;}.required {font-weight: bold;}
...
#profileimg{border-radius: 50%;width:150px;height:150px;margin:auto;}
.wrapper{display:none;}
#fileToUpload{display:none;}</style>
<?php include $_SERVER['DOCUMENT_ROOT'].'/include/navbar_framework/nav_sidebar_patho_home.php';?>
<div id="main">
<?php include $_SERVER['DOCUMENT_ROOT'].'/nav_bartop.php';?>
<?php include $_SERVER['DOCUMENT_ROOT'].'/addpatientform_body.php';?>