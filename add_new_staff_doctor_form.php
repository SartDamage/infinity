...
<hr class="seperator">
			...
			<div class="form-group  row justify-content-md-center "><!--Date of birth--><!--Contact no-->
			  ...
			  <div class="col-3 ">
				<input name="dob" class="form-control noerror" type="date" value="" id="age-input">
			  </div>
...
$('#designation-input-select option[value="Doctor"]').attr('selected', true);
fill_hidden("2","Doctor");
	...
	if (test==true){				//alert("hello in if loop");
									$.ajax({
										   ...
										   success: function(data)
										   {
												...
												{resetform(staff_reg_form);swalSuccess(data);location.reload();}
