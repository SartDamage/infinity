			   ...
			   success: function(data)
			   {
				  ...
				  //location.href = "./home.php"
					...
					//parseJsonToTable(json);
							...
							$.ajax({
			   type: "POST",
			   url: "/attmanager/get_all_user_id_name.php",//from global_variable
			   data: {uid:"2"}, //serializes the form's elements.
			   success: function(data1)
			   {
					var userdetails = JSON.parse(data1);
				  //on success take form data and enter to any pafe you require be it IPD or OPD or Patho.
				  //location.href = "./home.php"
						//console.log(json);
					parseJsonToTable(json,userdetails);
...
function parseJsonToTable(json,userdetails)
{
       ...
       var iconfal="<i class='fas fa-capsules'></i>";
			 ...
			 var iconfal="<i class='fas fa-tablets'></i>";
				...
				for (var j = 0; j < userdetails.length; j++) {
					if(json[i].user_name ==  userdetails[j].user_id && userdetails[j].user_id !="")
				tr.append("<td>" + userdetails[j].firstname + "</td>");
