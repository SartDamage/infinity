...
$db = getDB();
	...
	$statement=$db->prepare("INSERT INTO `add_delivery_details`(
		                            `reg_id`,
																 `pat_id`,
																 `ipd_opd_id`,
																 `uhid`,
		                              ...
		                              `method`,
			                                ...
			                                :gender,
																			...
																			`child_gender`=:gender_dup,
																			`method`=:method_delivery_dup,
																			`weight`=:delivery_weight_dup,
																			`no_child_born`=:Born_child_dup,
																			`wks`=:wks_dup,
																			`date_of_dl`=:delivery_date_dup,
																			`time_of_dl`=:delivery_time_dup,
																			`doctor`=:dr_name_dup,
																			`ot_id`=:ot_id1;");
