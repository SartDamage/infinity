		...
		<div class="card-block" id="print">
			...
			<form method="post" action="" class="form " name="pat_update_form"  id="pat_update_form" enctype="multipart/form-data" style="">
				...
				<div class="form-group row justify-content-center">
					...
					<div class="col-3">
					<select name="gender" class="form-control" id="gender" style="height: 44px;" onclick='dropdown_sub(this.name,"sub_test-0")'>
				...
				<div class="form-group row justify-content-center">
					...
					<div class="col-3">
					<input class="form-control" type="text" value=""  placeholder="Weight" name="delivery_weight" id="delivery_weight" autocomplete="off" onkeypress="return isNumberKey(event)" maxlength="10" >
					</div>
...
/* */?>
          ...
          <input type="hidden" id="ot_id" name="ot_id" value="<?php echo $_GET['opt_id'];?>" />
					</div>
